...
public class Rest {
	...
	private static final String hostURL = "https://stackoverflow.com/questions/5379247/filenotfoundexception-while-getting-the-inputstream-object-from-httpurlconnectio";
	...
	public static void setup(String request) {
		...
		{
			Log.e("donate","REST SETUP ERROR" + e.getMessage());
		}
	}
	...
	public static String get(String url) {
		...
		try {
            ...
            Log.e("donate", "GET REQUEST is : " + httpCon.getRequestMethod() + " " + httpCon.getURL());
            ...
            reader.close();
            Log.e("donate", "JSON GET REQUEST : " + stringBuilder.toString());
		}

        catch (Exception e) {
			Log.e("donate","GET REQUEST ERROR " + e);
		}
	...
	public static String post(String url, String json) {
        ...
        try {
            ...
            Log.e("donate","POST REQUEST ERROR" + e.getMessage());
        }
